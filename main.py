...
import os
import logging
from Anemobarometer_logger import AnemobarometerLogger
...
try:
    logger_WR = AnemobarometerLogger()
...
def run_app():
    '''
    Основная функция, запускающая весь код
    '''

    # Инициализируем класс Alarm
    alarm_1 = AlarmMode(17.5, 5) 
    alarm_2 = AlarmMode(17.5, 5)
    alarm_3 = AlarmMode(16, 2)
    alarm_4 = AlarmMode(19, 7.5)
